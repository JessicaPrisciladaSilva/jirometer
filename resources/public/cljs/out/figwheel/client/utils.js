...
var f = (function (){var pred__31178 = cljs.core._EQ_;
var expr__31179 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__31178.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__31179))){
return (function (p1__31172_SHARP_){
return console.warn(p1__31172_SHARP_);
});
} else {
if(cljs.core.truth_(pred__31178.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__31179))){
return (function (p1__31173_SHARP_){
return console.debug(p1__31173_SHARP_);
});
} else {
if(cljs.core.truth_(pred__31178.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__31179))){
return (function (p1__31174_SHARP_){
return console.error(p1__31174_SHARP_);
});
} else {
return (function (p1__31175_SHARP_){
return console.log(p1__31175_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__31182){
...
var eval_fn = cljs.core.get.call(null,map__31183__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__31185_SHARP_){
return new_def.callback(p1__31185_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__31186){
var vec__31187 = p__31186;
var ky = cljs.core.nth.call(null,vec__31187,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1594268126003
