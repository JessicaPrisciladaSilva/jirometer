...
var G__26242 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__26242;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__26243 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__26243,ch);
...
if(("\\" === ch__$1)){
var ch_26244__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_26244__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_26244__$2);
} else {
}
...
var vec__26253 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26253,(0),null);
var start_column = cljs.core.nth.call(null,vec__26253,(1),null);
...
var G__26256 = cljs.core.conj_BANG_.call(null,a,form);
a = G__26256;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__26257 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__26258 = true;
(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__26258);

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__26257);
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__26259 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26259,(0),null);
var start_column = cljs.core.nth.call(null,vec__26259,(1),null);
...
var vec__26262 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26262,(0),null);
var end_column = cljs.core.nth.call(null,vec__26262,(1),null);
...
var vec__26265 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26265,(0),null);
var start_column = cljs.core.nth.call(null,vec__26265,(1),null);
...
var vec__26268 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26268,(0),null);
var end_column = cljs.core.nth.call(null,vec__26268,(1),null);
...
var vec__26271 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26271,(0),null);
var start_column = cljs.core.nth.call(null,vec__26271,(1),null);
...
var vec__26274 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26274,(0),null);
var end_column = cljs.core.nth.call(null,vec__26274,(1),null);
...
var sb = (function (){var G__26277 = (new goog.string.StringBuffer());
G__26277.append(initch);
...
var G__26279 = (function (){var G__26278 = sb;
G__26278.append(ch);

return G__26278;
})();
var G__26280 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__26279;
ch = G__26280;
continue;
}
...
switch (G__26283) {
case "\\":
var G__26287 = (function (){var G__26284 = sb;
G__26284.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__26284;
})();
var G__26288 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__26287;
ch = G__26288;
continue;
...
break;
default:
var G__26289 = (function (){var G__26285 = sb;
G__26285.append(ch);

return G__26285;
})();
var G__26290 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__26289;
ch = G__26290;
continue;
...
var vec__26291 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26291,(0),null);
var end_column = cljs.core.nth.call(null,vec__26291,(1),null);
...
var vec__26294 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26294,(0),null);
var column = cljs.core.nth.call(null,vec__26294,(1),null);
...
var vec__26299 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26299,(0),null);
var column = cljs.core.nth.call(null,vec__26299,(1),null);
...
var vec__26304 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26304,(0),null);
var column = cljs.core.nth.call(null,vec__26304,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__26309 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26309,(0),null);
var start_column = cljs.core.nth.call(null,vec__26309,(1),null);
...
var vec__26312 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26312,(0),null);
var end_column = cljs.core.nth.call(null,vec__26312,(1),null);
...
var G__26315 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__26315,true,null,opts,pending_forms);
...
var G__26316 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__26316)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__26316)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__26316)){
...
var G__26319 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__26319,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__26319,rdr,first_line);
...
var G__26323 = matched;
var G__26324 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__26323;
finished = G__26324;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__26325 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__26326 = (function (){var or__4126__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__26326);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__26325);
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__26327 = cljs.tools.reader.arg_env;
var arg_env_temp_val__26328 = cljs.core.sorted_map.call(null);
(cljs.tools.reader.arg_env = arg_env_temp_val__26328);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__26329 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__26329,"(");
...
var G__26330 = (i + (1));
var G__26331 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4126__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
}finally {(cljs.tools.reader.arg_env = arg_env_orig_val__26327);
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__26332 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__26332);
...
var G__26335 = cljs.core.next.call(null,s);
var G__26336 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__26335;
key_vals = G__26336;
continue;
} else {
...
var gensym_env_orig_val__26341 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__26342 = cljs.core.PersistentArrayMap.EMPTY;
(cljs.tools.reader.gensym_env = gensym_env_temp_val__26342);
...
}finally {(cljs.tools.reader.gensym_env = gensym_env_orig_val__26341);
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__26343 = token;
var G__26343__$1 = (((G__26343 == null))?null:cljs.core.subs.call(null,G__26343,(1)));
var G__26343__$2 = (((G__26343__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__26343__$1));
var G__26343__$3 = (((G__26343__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__26343__$2));
var G__26343__$4 = (((G__26343__$3 == null))?null:cljs.core.symbol.call(null,G__26343__$3));
if((G__26343__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__26343__$4);
}
})():(function (){var G__26344 = token;
var G__26344__$1 = (((G__26344 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__26344));
if((G__26344__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__26344__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
(cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__26355,reader){
...
var eof = cljs.core.get.call(null,map__26356__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
//# sourceMappingURL=reader.js.map?rel=1594268123228
